...
<div id="topDiv">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<form id="form-search" class="form-inline">
								<input id="bjbh" class="form-control input-md form-search" placeholder="办件编号"> &nbsp; <input id="jgqc"
                                ...
                                <input id="xybgbh" class="form-control input-md form-search" placeholder="信用报告编号"> &nbsp; <input
									id="beginDate" class="form-control input-md form-search date-icon" placeholder="申请时间始" readonly="readonly">
								&nbsp; <input id="endDate" class="form-control input-md form-search date-icon" placeholder="申请时间止"
									readonly="readonly"> &nbsp;
	...
	<div id="columnTogglerContent" class="btn-group hide pull-right">
		...
		<div id="dataTable_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
			...
			</label><!--  <label> <input type="checkbox" class="icheck" data-column="9"> 审核状态
			</label>  --><!-- <label> <input type="checkbox" class="icheck" checked data-column="10"> 省报告
			</label>  --><label> <input type="checkbox" class="icheck" checked data-column="9"> 状态
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/center/creditReport/center_report_issue_list.js"></script>
