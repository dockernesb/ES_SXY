...
<body>
			...
			<div class="col-md-12">
				<div class="portlet box red-intense">
					<div class="portlet-title">
						...
						<div class="actions">
							<button class="btn btn-default btn-md" type="button" id="commitProvinceData">提交</button>
						</div>
					</div>
	...
	<div class="form-group" id="provinceDiv" style="display: none;">
		...
		<div class="col-md-7" style="position: absolute;top: 50%;left: 20%;">
			<div class="icheck-inline">
				<i class="fa"></i>
				<label><input type="checkbox" name="provinceSelected" id="provinceSelected" checked value="0"></input>上报至省平台
				</label>
			</div>
		</div>	
	</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/center/dpProvinceTheme/dpProvince.js"></script>
