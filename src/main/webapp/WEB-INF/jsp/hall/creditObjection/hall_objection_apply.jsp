...
<body>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab1">
										...
										<div id="qyxx" style="display: none;">
											...
											<div class="form-group">
												...
												<label class="control-label col-md-2"><span class="required">*</span> 组织机构代码证：</label>
												<div class="col-md-4">
									...
									<div class="tab-pane" id="tab3">
										...
										<div class="form-group">
											...
											<div class="col-md-2">
												<button type="button" class="btn btn-success upload-img" id="yyxxsqb">上传图片</button>
											</div>
									...
									<div class="tab-pane" id="tab4">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea class="form-control" id="ssbzView" readonly="readonly" rows="6"></textarea>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-2" id="yyxxsqbView"></div>
											<label class="control-label col-md-2">证明材料：</label>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/hall/creditObjection/hall_objection_apply.js"></script>
