...
<div id="mainListDiv">
						...
						<div class="col-md-12 col-sm-12">
							<form id="form-search" class="form-inline">
								<input id="bjbh" class="form-control input-md form-search" placeholder="办件编号"> &nbsp; <input id="xybgbh"
									class="form-control input-md form-search" placeholder="信用报告编号"> &nbsp; <input id="cxrxm"
									class="form-control input-md form-search" placeholder="姓名"> &nbsp; <input id="cxrsfzh"
									class="form-control input-md form-search" placeholder="身份证号">
	...
	<div id="columnTogglerContent" class="btn-group hide pull-right">
		...
		<div id="dataTable_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
			...
			</label> <label> <input type="checkbox" class="icheck" checked data-column="7"> 自然人是否存在
			</label>
			<c:if test="${audit == 1 }">
