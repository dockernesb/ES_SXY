...
<body>
							...
							<div class="form-body">
								...
								<div class="tab-content">
										...
										<div class="form-group">
											...
											<div class="col-md-1">
												<div class="input-icon left">
													<button type="button" class="btn blue btn-md form-search" id= "djbrsfz">
														<i class="fa"></i> 读身份证
													</button>
												</div>
											</div>
									...
									<div class="tab-pane" id="tab3">
										...
										<div class="form-group">
											<label class="control-label col-md-3"> <span class="required">*</span> 区域部门：
											</label>
											<div class="col-md-6">
												<div class="input-icon right">
													<i class="fa"></i>
													<input class="form-control" name="areaDepts" id="areaDepts" style="width: 100%" placeholder="例如：苏州市姑苏区经济和信息化局"/>												
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3"> <span class="required">*</span> 项目名称：
											</label>
											<div class="col-md-6">
												<div class="input-icon right">
													<i class="fa"></i>
													<input class="form-control" name="projectName" id="projectName" style="width: 100%" placeholder="例如：2017年度姑苏区、保护区促进信息产业发展专项资金项目"/>												
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3"> <span class="required">*</span> 项目细类：
											</label>
											<div class="col-md-6">
												<div class="input-icon right">
													<i class="fa"></i>
													<input class="form-control" name="projectXL" id="projectXL" style="width: 100%" placeholder="例如：A3类-社会信息化类项目"/>												
												</div>
											</div>
										</div>
										<div class="form-group">
									...
									<div class="tab-pane" id="tab4">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input class="form-control-d" id="areaDeptsView" readonly="readonly" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3"> 项目名称： </label>
											<div class="col-md-6">
												<input class="form-control-d" id="projectNameView" readonly="readonly" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3"> 项目细类： </label>
											<div class="col-md-6">
												<input class="form-control-d" id="projectXLView" readonly="readonly" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3"> 备注： </label>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("textarea").next("span.phTips").css("margin-top", "-115px");
        });
	</script>
