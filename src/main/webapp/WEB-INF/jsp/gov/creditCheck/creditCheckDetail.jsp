			...
			<form id="creditCheckApplyForm" method="post" class="form-horizontal">
				<div class="form-body">
					...
					<div class="form-group" style="padding-right: 15px; display: none;" id="shfj">
						...
						<div class="col-md-4">
							<%--<button type="button" class="btn btn-success" onclick="creditCheckDetail.downLoadReport('${path_hcfj}', '${path_hcfjName}');" >下载审查报告</button>--%>
							<c:if test="${uploadFile_shfj != null}">
								<button type="button" class="btn btn-success" onclick="creditCheckDetail.downLoadReport('${uploadFile_shfj.filePath}', '${uploadFile_shfj.fileName}');">下载审查报告</button>
							</c:if>
						</div>
					</div>
				</div>
