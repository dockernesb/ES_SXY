var centerPReport = (function() {
	...
	var table = $('#dataTable').DataTable({
		...
		columns : [ {
			...
			"data" : "xybgbh",
			"render" : function(data, type, full) {
				var opts = '<a href="javascript:;" onclick="centerPReport.toReportViewPrint(\'' + data + '\', \'' + full.id + '\', this, \'' + full.cxrxm + '\')">' + data + '</a>';
				return opts;
			}
		}, {
			"data" : "cxrxm"
	...
	function conditionReset() {
		resetSearchConditions('#bjbh,#cxrxm,#cxrsfzh,#beginDate,#endDate,#xybgbh,#status,#deptId');
		resetDate(start, end);
	}
