package com.udatech.gov.dataAnalysis.vo;
 ...
 */
public class AnalysisCriteria implements java.io.Serializable {
    ...
    public static final String HISTOGRAM = "3";//柱状图
    public static final String QUERY_TOTAL = "0";
