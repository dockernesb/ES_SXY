...
public class ExcelUtils4 {
    ...
    private static Logger logger = Logger.getLogger(ExcelUtils4.class);
    ...
    public static void makeStreamExcel(String sheetName, String[] titles1, String[] titles1spans, String[] titles2, List<List<String>> data, boolean isAutoWidth, OutputStream os, String[] cellWidths) {
        ...
        CellRangeAddress cra2 = new CellRangeAddress(0, 0, 3, 4);
        CellRangeAddress cra3 = new CellRangeAddress(0, 0, 5, 6);
