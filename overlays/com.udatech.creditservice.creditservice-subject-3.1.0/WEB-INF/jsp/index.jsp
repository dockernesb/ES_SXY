...
<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo" onload="openIndex(${userType});">
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				...
				<span id="logoText" class="logoText">集中认证管理系统</span>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
						<a href="javascript:;" title="主页" onclick="gotoHome();" style="width: 41.25px;" class="dropdown-toggle" data-toggle="dropdown"
					...
					<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
						<a href="javascript:;" onclick="showMessage();" title="系统消息" style="width: 41.25px;" class="dropdown-toggle" data-toggle="dropdown"
							data-hover="dropdown" data-close-others="true">
							<i class="icon-envelope"></i> <span class="badge badge-default" id="msgLabel"></span>
						</a>
					</li>
					<!-- END INBOX DROPDOWN -->
	...
	<div class="page-footer">
		...
		<em class="pull-right" style="padding-right: 25px;">集中认证管理系统 Version ${version }</em>
		...
		<form id="editPwdForm" method="post" class="form-horizontal">
			...
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-3 control-label"><span class="required">*</span> 原密码:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="col-md-3 control-label"><span class="required">*</span> 新密码:</label>
					<div class="col-sm-8">
						<div class="input-icon right">
							<i class="fa"></i>
