...
<div class="row" id="templateRow">
    <div class="col-md-12">
        <div class="portlet box red-intense">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="javascript:void(0);" onclick="creditTemplete.watermarkManage();" class="btn btn-default btn-sm hide">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2 preprinttab">
                        <ul class="nav nav-tabs tabs-left">
                            <c:forEach var="template" items="${templateList}" varStatus="status">
                                ...
                                <a href="#${template.id }" data-toggle="tab" title="${template.creditName}"
                                   onclick="creditTemplete.previewReport(this);">
                                    <c:if test="${template.isDefault == 0 }">
                                        <span class="badge badge-default" id="msgLabel">默认</span>
                                    </c:if>
                                        ${template.creditName}
                                </a>
                                <input id="category_${template.id }" value="${template.category}" type="hidden"/>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <c:forEach var="template" items="${templateList}" varStatus="status">
                                ...
                                <c:if test="${status.index > 0 }">
                                    ...
                                    <h4>模板【${template.creditName}】产生的信用审查报告打印预览</h4>
                                    <div class="row">
                                        <div class="col-md-12">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/app/js/common/resourceManage/templateSC.js"></script>
