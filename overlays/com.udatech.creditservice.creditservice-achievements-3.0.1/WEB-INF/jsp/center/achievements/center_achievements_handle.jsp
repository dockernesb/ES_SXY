            ...
            <div class="portlet-body">
                ...
                <form id="submit_form">
                                            ...
                                            <td style="width: 10%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score100100" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score100100center}"/></textarea>
                                                </div>
                                            </td>
                                            <td style="width: 20%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc100100" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc100100center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score100101" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score100101center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc100101" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc100101center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score100102" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score100102center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc100102" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc100102center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score100103" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score100103center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc100103" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc100103center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score100104" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score100104center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc100104" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc100104center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td style="width: 10%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101100" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101100center}"/></textarea>
                                                </div>
                                            </td>
                                            <td style="width: 20%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101100" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101100center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101101" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101101center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101101" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101101center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101102" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101102center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101102" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101102center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101103" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101103center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101103" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101103center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101104" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101104center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101104" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101104center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101105" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101105center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101105" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101105center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score101106" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score101106center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc101106" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc101106center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td style="width: 10%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score102100" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score102100center}"/></textarea>
                                                </div>
                                            </td>
                                            <td style="width: 20%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc102100" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc102100center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score102101" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score102101center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc102101" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc102101center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score102102" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score102102center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc102102" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc102102center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td style="width: 10%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score103100" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score103100center}"/></textarea>
                                                </div>
                                            </td>
                                            <td style="width: 20%;">
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc103100" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc103100center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="score103101" class="score-input form-control"
                                                            ...
                                                            value="${kpis.score103101center}"/></textarea>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-icon right">
                                                    ...
                                                    <textarea id="desc103101" class="desc-input form-control" name="desc"><c:out
                                                            value="${kpis.desc103101center}"/></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <div class="form-group" style="overflow: hidden;">
                                    ...
                                    <c:forEach var="t" items="${achievements.bmfj}">
                                        <div class="preview-file">
                                            ...
                                            <div class="preview-operate">
                                                <div class="preview-download" onclick="downloadFile('${t.uploadFileId}');">下载</div>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
                        ...
                        <div class="col-md-6">
                            中心附件：
                            <button type="button" class="btn btn-success upload-file" id="zxfj">上传附件</button>
                            <c:if test="${achievements.zxfj != null}">
                                <div class="preview-img-panel">
                                    <c:forEach var="t" items="${achievements.zxfj}">
                                        <div class="preview-file">
                                            ...
                                            <input type="hidden" name="zxfjName" value="${t.fileName}">
                                            <input type="hidden" name="zxfjPath" value="${t.filePath}">
                                        </div>
                                    </c:forEach>
                                </div>
                            </c:if>
                ...
                <div class="form-actions" style="text-align: center;">
                    ...
                    <a href="javascript:;" id="rejectBtn" class="btn red"> 驳回 </a>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/app/js/center/achievements/center_achievements_handle.js"></script>
