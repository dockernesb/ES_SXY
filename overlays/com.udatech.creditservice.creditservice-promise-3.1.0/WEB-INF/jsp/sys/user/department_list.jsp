					...
					<div class="row">
						<div class="col-md-12">
							<form class="form-inline">
								<input id="deptCode" class="form-control input-md" placeholder="部门编码" /> &nbsp; 
								<input id="deptName" class="form-control input-md" placeholder="部门名称" /> &nbsp;
	...
	<div id="winAdd" style="display: none; margin: 30px 40px">
		<form id="addDepartmentForm" method="post" class="form-horizontal">
			...
			<div class="form-body">
				...
				<div class="form-group">
					<label class="col-md-3 control-label"><span class="required">*</span> 部门负责人</label>
					<div class="col-sm-8">
						<div class="input-icon right">
							<i class="fa"></i> 
							<select class="form-control" name="adminUserId1" id="adminUserId1" style="width: 100%">
							</select>
						</div>
					</div>
				</div>
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-icon right">
							<i class="fa"></i> 
							<select class="form-control" name="adminUserId2" id="adminUserId2" style="width: 100%">
							</select>
						</div>
					</div>
				</div>
