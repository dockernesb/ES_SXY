var dept = function() {
	...
	$.getJSON(ctx + "/system/user/alluser.action", function(result) {
		...
		$("#adminUserId1").change(function(){
			addValidator.form();
		});
		
		$("#adminUserId2").change(function(){
			editValidator.form();
		});
	});
	...
	function editDepartment() {
		...
		if (gridNodes.length == 1) {
			...
			$("#adminUserId2").val(node.adminUserId).trigger("change");
