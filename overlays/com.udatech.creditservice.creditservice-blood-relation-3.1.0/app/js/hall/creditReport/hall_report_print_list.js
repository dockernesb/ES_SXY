var holPrint = (function () {
    ...
    var table = $('#dataTable').DataTable({
        ...
        columns: [{
            ...
            "data": "xybgbh",
            "render": function (data, type, full) {
                var opts = '<a href="javascript:;" onclick="holPrint.toReportViewPrint(\'' + data + '\', \'' + full.id + '\', this)">' + data + '</a>';
                return opts;
            }
        }, {
            "data": "qymc"
    ...
    function refreshTable(bjbh, jgqc, gszch, zzjgdm, tyshxydm, xybgbh, beginDate, endDate) {
        if (table) {
    ...
    function conditionSearch() {
        ...
        refreshTable(bjbh, jgqc, gszch, zzjgdm, tyshxydm, xybgbh, beginDate, endDate);
    }
