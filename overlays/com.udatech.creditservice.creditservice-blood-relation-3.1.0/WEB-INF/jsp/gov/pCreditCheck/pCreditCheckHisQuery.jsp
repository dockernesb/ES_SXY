...
<body>
	<div id="topBox">
						...
						<div class="col-md-12">
							<form class="form-inline" id="applyListForm">
								<div class="row">
									...
									<button type="button" class="btn btn-info btn-md form-search" onclick="pCreditCheckHisQuery.conditionSearch();">
										<i class="fa fa-search"></i> 查询
									</button>
									<button type="button" class="btn btn-default btn-md form-search" onclick="pCreditCheckHisQuery.conditionReset();">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/gov/pCreditCheck/pCreditCheckHisQuery.js"></script>
