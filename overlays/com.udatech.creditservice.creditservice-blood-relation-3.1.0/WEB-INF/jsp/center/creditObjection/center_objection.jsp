...
<body>
											...
											<tr>
												<td class="title" colspan="2">
													...
													<span style="float: right;">
														<c:if test="${ci.status == 4}">
															<c:if test="${dataStatus == 3}">
																<span style="color: red; font-weight: bold;">[&nbsp;已删除&nbsp;]</span>
															</c:if>
															<c:if test="${dataStatus == 4}">
																<span style="color: green; font-weight: bold;">[&nbsp;已修正&nbsp;]</span>
																<button type="button" class="btn btn-sm green-meadow" onclick="co.viewHistory();">查看</button>
															</c:if>
														</c:if>
													</span>
												</td>
	...
	<div id="historyDiv" style="display: none; overflow-x: hidden;">
		<form id="historyForm" action="#" class="form-horizontal">
			<div class="form-group">
				<label class="control-label col-md-3"></label>
				<label class="control-label col-md-4" style="text-align: left;">修正前数据</label>
				<label class="control-label col-md-4" style="text-align: left;">修正后数据</label>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/center/creditObjection/center_objection.js"></script>
