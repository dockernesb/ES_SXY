            ...
            <div class="portlet-body">
                ...
                <div style="margin: 0px 60px 60px 60px;display: none;" id="dept_sonDiv" >
                    ...
                    <div id="detail_dept_btn" class="hide pull-right">
                        ...
                        <a class="btn btn-sm blue" href="javascript:;" onclick="dataTimeline.exportDeptDetailData();">导出</a>
                        <a class="btn btn-sm blue" href="javascript:;" onclick="dataTimeline.goBack();">返回</a>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/center/statisAnalyze/data_timeliness.js"></script>
