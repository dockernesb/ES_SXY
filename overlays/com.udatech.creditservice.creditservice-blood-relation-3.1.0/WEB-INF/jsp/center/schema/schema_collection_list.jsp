...
<div id="topBox">
    <div id="parentBox">
                ...
                <div class="portlet box red-intense">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            ...
                            <a href="javascript:void(0);" onclick="collectionBlood.showCetl();" class="btn btn-default btn-sm"> 数据血缘 </a>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="${ctx}/app/js/center/schema/schema_blood_list.js"></script>
