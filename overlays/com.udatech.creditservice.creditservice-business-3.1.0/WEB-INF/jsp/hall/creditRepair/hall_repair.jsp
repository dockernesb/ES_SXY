...
<body>
						...
						<div class="form-wizard">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea class="form-control" readonly="readonly" rows="5">${er.xfbz}</textarea>
									</div>
								</div>
								<div class="form-group">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/hall/creditRepair/hall_repair.js"></script>
