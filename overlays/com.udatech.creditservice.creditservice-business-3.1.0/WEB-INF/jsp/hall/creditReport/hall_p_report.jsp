						...
						<div class="form-wizard">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input id="sqbgqssjView" class="form-control input-md " value="<fmt:formatDate value="${po.sqbgqssj }" pattern="yyyy年MM月dd日" />"
											readonly="readonly">
									</div>
									<div class="col-md-3">
										<input id="sqbgjzsjView" class="form-control input-md " value="<fmt:formatDate value="${po.sqbgjzsj }" pattern="yyyy年MM月dd日" />"
											readonly="readonly">
									</div>
								</div>
								<div class="form-group">
