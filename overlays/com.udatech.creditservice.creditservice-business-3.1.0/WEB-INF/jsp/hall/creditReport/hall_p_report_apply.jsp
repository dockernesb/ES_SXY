										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="input-icon right">
													...
													<input class="form-control" id="searchInput" name="sfzh" style="padding-right: 63px;" placeholder="请输入查询人身份证号" />
												</div>
											</div>
										</div>
										<div id="brxx">
											<div class="form-group">
												...
												<div class="col-md-6">
													<input class="form-control" id="cxrxm" name="cxrxm" />
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3"><span class="required">*</span> 身份证号：</label>
												<div class="col-md-6">
													<input class="form-control" id="cxrsfzh" name="cxrsfzh" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-icon right">
														...
														<input class="form-control" id="wtsearchInput" name="sfzh" style="padding-right: 55px;" placeholder="请输入委托人身份证号" />
													</div>
												</div>
											</div>
											<div id="wtrxx">
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<input class="form-control" id="wtrsfzh" name="wtrsfzh" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-6">
														<div class="input-icon right">
															<i class="fa"></i>
															<input class="form-control" id="wtrlxdh" name="wtrlxdh" />
														</div>
													</div>
												</div>
												<div class="form-group">
