		...
		<div class="col-md-12">
			<div class="portlet box red-intense">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-list"></i> 信用报告申请单查看
					</div>
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input id="sqbgqssjView" class="form-control input-md "
											value="<fmt:formatDate value="${eo.sqbgqssj }" pattern="yyyy年MM月dd日" />" readonly="readonly">
									</div>
									<div class="col-md-3">
										<input id="sqbgjzsjView" class="form-control input-md "
											value="<fmt:formatDate value="${eo.sqbgjzsj }" pattern="yyyy年MM月dd日" />" readonly="readonly">
									</div>
								</div>
								<div class="form-group">
