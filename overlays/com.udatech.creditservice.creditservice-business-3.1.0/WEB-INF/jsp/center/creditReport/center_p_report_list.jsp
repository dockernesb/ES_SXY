    ...
    <div id="mainListDiv">
        ...
        <div id="columnTogglerContent" class="btn-group hide pull-right">
            ...
            <div id="dataTable_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                ...
                <label> <input type="checkbox" class="icheck" checked data-column="2"> 姓名</label>
                <label> <input type="checkbox" class="icheck" checked data-column="3"> 身份证号</label>
                <label> <input type="checkbox" class="icheck" checked data-column="4"> 申请时间</label>
                <label> <input type="checkbox" class="icheck" checked data-column="5"> 申请人</label>

                <c:if test="${audit == 1 }">
                    <label> <input type="checkbox" class="icheck" checked data-column="6"> 状态</label>
                </c:if>
                <c:if test="${audit == 0 }">
                    <label> <input type="checkbox" class="icheck" data-column="6"> 状态</label>
                </c:if>
            </div>
        </div>
    </div>
