...
function init() {
	...
	$content.append('<p class="f_16">社会自然人信用基础数据库信息来源于省、市有关政府部门。有何问题，请与我们联系。地址：' + templateJsonObj.address + '，电话：' + templateJsonObj.contactPhone + '，联系人：' + templateJsonObj.contact + '。</p>');
}
...
function printDetail() {
	var btnPrint = document.getElementById("print_button");
