...
<body>
				...
				<div class="portlet-body">
					<div class="topBox" id="topBox">
						<form id="form-search" class="form-inline">
						    ...
						    <button type="button" class="btn btn-info btn-md "  onclick="industryCredit.conditionSearch();">
							<i class="fa fa-search"></i>查询
							</button>
							<button type="button" class="btn btn-default btn-md " onclick="industryCredit.conditionReset();">
					...
					<div class="col-md-12 col-sm-12" style="margin:30px 0 40px;">
					...
					<div class="col-md-6 col-sm-6" >
					    <span class="chart-title">行业分级</span>
						<div id="percentPie">
						<div id="svgBox"></div>
						<div id="floatInfo" style="display:none"></div>
						</div>
					</div>
						...
						<table id="dataTable" class="table table-striped table-bordered table-hover">
							<thead>
								<tr role="row" class="heading">
									...
									<th rowspan="2" style="vertical-align:middle;">行业门类</th>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/center/multipleAnalysis/industry_credit.js"></script>
	<script type="text/javascript">
