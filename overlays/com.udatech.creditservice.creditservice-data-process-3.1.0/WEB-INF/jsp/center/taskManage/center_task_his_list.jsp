...
<div id="topBox">
    <div id="parentBox">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="taskGrid">
                            ...
                            <tr class="heading">
                                ...
                                <th style="width: 100px;">目录名称</th>
                                <th style="text-align: center">上报量</th>
                                <th style="text-align: center">疑问量<%--<i class="fa fa-question-circle" style="color: #e35b5a;"
                                                                     title="疑问数据请尽快处理，超过${reportValidDays}天疑问数据将自动确认不可修改"></i>--%></th>
        ...
        <script type="text/javascript" src="${ctx}/app/js/center/taskManage/center_task_his_list.js"></script>
