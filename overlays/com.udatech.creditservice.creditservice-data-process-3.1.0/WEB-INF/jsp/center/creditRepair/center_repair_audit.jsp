...
<body>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<div class="input-icon right">
											<i class="fa"></i>
											<textarea id="zxshyj" name="zxshyj" rows="4" class="form-control"></textarea>
										</div>
									</div>
								</div>
							</div>
							<div class="form-actions" style="text-align: center;">
								<a href="javascript:;" id="bmBtn" class="btn green"> 部门核实 </a>
	...
	<input type="hidden" id="businessId" value="${er.id}" />
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/center/creditRepair/center_repair_audit.js"></script>
