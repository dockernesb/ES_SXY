...
<body>
	...
	<input type="hidden" id="jgqc" value="${qyxx.JGQC}" />
				...
				<div class="portlet-body form">
					...
					<p>
						<span style="color: #e02222; font-size: 14px;">
                            <b>注：</b>1.列表中红色背景的数据，表示该信用数据已完成信用修复。<br/>
							<b style="visibility: hidden;">注：</b>2.列表中黄色背景的数据，表示该信用数据已发起异议申诉申请但尚未处理完成。<br/>
                            <b style="visibility: hidden;">注：</b>3.列表中紫色背景的数据，表示该信用数据已发起信用修复申请但尚未处理完成。
                        </span>
					</p>
					...
					<div class="form-actions" style="text-align: center;">
						<a href="javascript:void(0);" id="preStepBtn" class="btn default">上一步</a>
						<a href="javascript:;" id="shtgBtn" class="btn blue"> 确定 </a>						
						<!-- <a href="javascript:;" class="btn backBtn default"> 返回列表页 </a> -->
					</div>
