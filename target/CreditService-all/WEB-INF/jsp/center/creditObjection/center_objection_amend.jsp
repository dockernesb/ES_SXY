...
<div id="applyDetailDiv" style="display:none">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/app/js/center/creditObjection/center_objection_amend.js"></script>
