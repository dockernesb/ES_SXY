...
<body>
	<div class="portlet box red-intense">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-file-text-o"></i>自然人信用审查详细
			</div>
			<div class="tools" style="padding-left: 5px;">
				<a href="javascript:void(0);" class="collapse"></a>
			</div>
			<div class="actions">
				<button type="button" class="btn btn-default" onclick="cCreditCheckDetail.goBack();">
			...
			<form id="creditCheckApplyForm" method="post" class="form-horizontal">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
								<textarea id="scxxl" style="resize: none;"  rows="3" class="form-control" maxlength="100" readonly="readonly">${scxxl }</textarea>
						</div>
					...
					<div class="form-group">
						<c:if test="${not empty path_sqfj}">
							...
							<div class="col-md-10">
								<button type="button" class="btn btn-success" onclick="cCreditCheckDetail.downLoadReport('${path_sqfj}', '${path_sqfjName}');">下载附件</button>
							</div>
						</c:if>
					</div>
					<hr>
					...
					<div class="form-group" style="padding-right: 15px; display: none;" id="shyj">
						...
						<div class="col-md-4">
							<textarea rows="3" class="form-control" readonly="readonly">${creditExamineHis.opinion}</textarea>
						</div>
					</div>
					<div class="form-group" style="padding-right: 15px; display: none;" id="shfj">
						<label class="control-label col-md-1">附件</label>
						<div class="col-md-4">
							<button type="button" class="btn btn-success" onclick="cCreditCheckDetail.downLoadReport('${path_hcfj}', '${path_hcfjName}');">点击下载审查报告</button>
						</div>
					</div>
				</div>
			</form>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/center/pCreditCheck/pCreditCheckDetail.js"></script>
