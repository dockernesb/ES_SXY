        ...
        <div class="portlet box red-intense">
            ...
            <div class="portlet-body form">
                <form action="#" class="form-horizontal" id="submit_form" method="POST">
                    <input type="hidden" id="id" value="${pCreditExamine.id}"/><br/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input class="form-control" value="${pCreditExamine.scmc}" readonly="readonly"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/app/js/center/pCreditCheck/pSubmit_check_report.js"></script>
