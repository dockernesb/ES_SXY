...
<body>
	<div class="portlet box red-intense">
		<div class="portlet-title">
			<div class="caption">
				<i class="glyphicon glyphicon-floppy-saved"></i>自然人信用审查审核
			</div>
			<div class="tools" style="padding-left: 5px;">
				<a href="javascript:void(0);" class="collapse"></a>
			</div>
			<div class="actions">
				<button type="button" class="btn btn-default" onclick="cCreditCheckExamine.goBack();">
			...
			<form id="cCreditCheckExamineForm" method="post" class="form-horizontal">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
								<textarea rows="3" style="resize : none;" class="form-control" maxlength="100" readonly="readonly" id="scxxl">${scxxl }</textarea>
						</div>
					...
					<div class="form-group">
						<c:if test="${not empty path_sqfj}">
							...
							<div class="col-md-10">
								<button type="button" class="btn btn-success" onclick="cCreditCheckExamine.downLoadReport('${path_sqfj}', '${path_sqfjName}');">下载附件</button>
							</div>
						</c:if>
					</div>
					<hr>
					<div class="form-group" style="padding-right: 15px;">
						<label class="col-md-2" style="font-size: 18px;">自然人名单 </label>
					</div>
					<div class="form-group">
						<div class="col-md-12 portlet-body">
							<table class="table table-striped table-hover table-bordered" id="enterGrid" style="width: 100%;">
								<thead>
									<tr class="heading">
										<th style="width: 4%;"></th>
										<th style="width: 29%;">姓名</th>
										<th style="width: 57%;">身份证号</th>
									</tr>
								</thead>
							</table>
						</div>
					...
					<div class="form-group" style="padding-right: 15px;">
						<label class="control-label col-md-1">审核意见</label>
							<div class="col-md-4"><div class="input-icon right">
								<i class="fa"></i>
								<textarea rows="4" style="resize: none;" class="form-control" id="shyj" name="shyj"></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12 text-center">
							<button type="button" class="btn btn-primary" onclick="cCreditCheckExamine.examine(true);">审核通过</button>
							<button type="button" class="btn btn-danger" onclick="cCreditCheckExamine.examine(false);">审核不通过</button>
						</div>
					</div>
				</div>
			</form>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/center/pCreditCheck/pCreditCheckExamine.js"></script>
