...
<body>
	<div class="portlet box red-intense">
		<div class="portlet-title">
			...
			<div class="actions">
				<button type="button" class="btn btn-default" onclick="cCreditCheckDetail.goBack();">返回</button>
			</div>
		</div>
			...
			<form id="creditCheckApplyForm" method="post" class="form-horizontal">
				<div class="form-body">
					...
					<div class="form-group" style="padding-right: 15px; display: none;" id="shfj">
						...
						<div class="col-md-4">
							<c:if test="${path_hcfj != null}">
								<button type="button" class="btn btn-success" onclick="cCreditCheckDetail.downLoadReport('${path_hcfj}', '${path_hcfjName}');">下载审查报告</button>
							</c:if>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/app/js/center/creditCheck/cCreditCheckDetail.js"></script>
