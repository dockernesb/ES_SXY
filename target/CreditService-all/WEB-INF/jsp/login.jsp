...
<body class="login">
	...
	<div class="content">
		...
		<form action="${ctx}/login.action" class="login-form" method="post" id="loginForm">
			...
			<h3 class="form-title"><b>账号登录</b><a href="${ctx}/loginCa.action">CA登录</a></h3>
	...
	<script type="text/javascript" src="${ctx}/$_staticResource_$/global/plugins/backstretch/jquery.backstretch.min.js"></script>
