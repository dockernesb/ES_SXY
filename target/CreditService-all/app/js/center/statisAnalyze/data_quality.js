var dataQuality = (function() {
  ...
  //改变统计主体
        ...
        columns: [
            ...
            {"data" : "DEPARTMENT_NAME",
                ...
                render : function (data, type, row) {
                    var str = '<a href="javascript:;" onclick="dataQuality.showDetail(\'' + row.ID + '\')">' + data + '</a>';
                    return str;
                }},
            {"data" : "ALL_SIZE"},
            {"data" : "YXG_SIZE"},
    ...
    var schemaTable = $('#dataSchemaTable').DataTable({
        ...
        columns: [
            ...
            {"data" : "NAME", type: 'chinese-string',
                render : function (data, type, row) {
                    var str = '<a href="javascript:;" onclick="dataQuality.showSchemaDetail(\''+ data +'\');">' + data + '</a>';
                    return str;
                }},
            {"data" : "ALL_SIZE"},
            {"data" : "YXG_SIZE"},
	...
	function exportData(isDeptGroup) {
        ...
        _form.append($("<input>", {'type': 'hidden', 'name': 'deptQueryType', 'value': deptQueryType}));
        //触发提交事件
    ...
    function exportDeptDetailData() {
        ...
        _form.append($("<input>", {'type': 'hidden', 'name': 'deptQueryType', 'value': tjzt}));
        _form.append($("<input>", {'type': 'hidden', 'name': 'startDate', 'value': startDate}));
        _form.append($("<input>", {'type': 'hidden', 'name': 'endDate', 'value': endDate}));
        _form.append($("<input>", {'type': 'hidden', 'name': 'titles', 'value': titles}));
        _form.append($("<input>", {'type': 'hidden', 'name': 'columns', 'value': columns}));
