var sociaLegalPerson = (function () {
    ...
    // 打开业务追溯页面
    function onBusinessTrace() {
        $.openWin({
            title: '数据追溯：' + qymc,
            type: 2,
            content: ctx + '/dataTrace/toDataTrace.action?qyid=' + qyid + '&qymc=' + qymc,
            btnAlign: 'c',
            btn: [],
            area: ['90%', '90%'],
        ...
        $("#layui-layer6 .layui-layer-btn").remove();
    }
    ...
    return {
        'goBack': goBack,
        'onBusinessTrace': onBusinessTrace
    }
})();