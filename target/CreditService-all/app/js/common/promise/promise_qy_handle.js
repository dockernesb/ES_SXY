(function() {
	...
	$("#backBtn,#backBtn2").click(function() {
		var url = ctx + "/promise/toPromiseQyList.action?cnlb=" + cnlb + "&deptId=" + deptId;
		if (type == 1) {
			url = ctx + "/promise/toPromiseQyViewList.action";
		}
	...
	function saveSupervisionTheme() {
		...
		$("#submit_form").ajaxSubmit({
			url : ctx + "/promise/savePromiseQyHandle.action",
