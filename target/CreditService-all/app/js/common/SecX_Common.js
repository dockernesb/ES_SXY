...
function OnUsbKeyChange()
{
 ...
 try {
	if (window.ActiveXObject || 'ActiveXObject' in window) {
		...
		var XTXAPP = document.getElementById("XTXAPP");
		...
		var XTXAPP = document.getElementById("XTXAPP0");
	...
	alert("控件可能没有注册成功！请先下载控件，下载地址为：http://www.ca.suzhou.gov.cn/Downloads.aspx?id=37"+e.message);
}
