var cpl = (function() {
	...
	var table = $('#dataTable').DataTable({
        ajax: {
            url: ctx + "/promise/getPromiseList.action",
            type: "post"
        },
        ordering: false,
        searching: false,
        ...
        columns: [
            ...
            {"data" : "CN_FILE", "render": function(data, type, full) {
            	...
            	if (data) {
            		...
            		opts += '<a href="javascript:;" class="opbtn btn btn-xs red" onclick="cpl.deleteFileInfo(\'' + data.uploadFileId + '\', \'' + data.businessId + '\')">删除</a>';
            	} else {
            ...
            {"data" : "ID", "render": function(data, type, full) {
            	var opts = '<a href="javascript:;" class="opbtn btn btn-xs green-meadow" onclick="cpl.toPromiseQyList(\'' + full.DICT_KEY + '\', \'' + full.DEPT_ID + '\')">管理承诺企业</a>';
				return opts;
			}}
        ],
	...
	function toPromiseQyList(cnlb, deptId) {
