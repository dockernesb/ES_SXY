var sszjStatistics = (function () {
    ...
    var table = $('#dataTable').DataTable({
        ...
        initComplete: function (settings, data) {
            ...
            //小计数
            $('#tableHeader').find('th').eq(1).text(zjxxCount);
            $('#tableHeader').find('th').eq(2).text(cyryCount);
            $('#tableHeader').find('th').eq(3).text(pjxxCount);
            $('#tableHeader').find('th').eq(4).text(hejiCount);
        },
